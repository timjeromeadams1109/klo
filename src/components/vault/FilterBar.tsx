...
function SelectDropdown({
  ...
  return (
    <select
      ...
      className="bg-[#011A5E] border border-[#0E3783] rounded-lg px-3 py-2 text-sm text-klo-text appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#68E9FA]/50 focus:border-[#68E9FA]/50 transition-all duration-200 pr-8"
      style={{
