...
const slideDir = "/tmp/platform-guide-slides/";
try { mkdirSync(slideDir, { recursive: true }); } catch {}

const browser = await chromium.launch();
const page = await browser.newPage({ viewport: { width: 1920, height: 1080 } });

await page.goto("file:///Users/timothyadams/klo-app/public/platform-guide.html", { waitUntil: "networkidle" });
...
pptx.subject = "The KLO Platform — Complete Guide";
pptx.title = "The KLO Platform — Complete Guide";
...
const outPath = "/Users/timothyadams/klo-app/public/platform-guide.pptx";
